...
class Employees(models.Model):
    ...
    addressdetails = models.ForeignKey(AddressDetails, on_delete=models.CASCADE, related_name="addressdetails")
    roles = models.ForeignKey(Roles, on_delete=models.CASCADE, related_name="roles")
